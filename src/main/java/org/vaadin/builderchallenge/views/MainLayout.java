package org.vaadin.builderchallenge.views;
...
import org.vaadin.builderchallenge.components.appnav.AppNav;
import org.vaadin.builderchallenge.components.appnav.AppNavItem;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        if (accessChecker.hasAccess(AdminView.class)) {
            nav.addItem(new AppNavItem("Admin", AdminView.class, LineAwesomeIcon.WRENCH_SOLID.create()));
